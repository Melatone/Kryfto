...
class _MapPageSelectState extends State<MapSelectPage> {
  static const initCameraPosition =
      CameraPosition(target: LatLng(-36.853940, 174.764620), zoom: 16);
        ...
        appBar: AppBar(
          ...
          title: Text(
            ...
            style: GoogleFonts.righteous(
                textStyle: TextStyle(
                    fontSize: 40, color: Theme.of(context).backgroundColor)),
          ),
                      ...
                      setState(() {
                        showDialog(
                            ...
                            builder: (context) => CupertinoAlertDialog(
                                    title: Text("Confirm"),
                                    content: Text(
                                        "Please confirm your Boundary Selection"),
                                    actions: [
                                                  ...
                                                  builder: (context) =>
                                                      CupertinoAlertDialog(
                                                          title: Text(
                                                              "Invalid Boundary"),
                                                          content: Text(
                                                              "Please create a boundary with at least 3 corners."),
                                                          actions: [
                                                            CupertinoDialogAction(
                                                                child:
                                                                    Text("OK"),
